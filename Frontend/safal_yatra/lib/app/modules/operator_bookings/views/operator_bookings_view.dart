...
class OperatorBookingsView extends GetView<OperatorBookingsController> {
  var showBackArrow = Get.arguments;
  OperatorBookingsView({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(OperatorBookingsController());
    ...
    return Scaffold(
      ...
      body: GetBuilder<OperatorBookingsController>(builder: (controller) {
