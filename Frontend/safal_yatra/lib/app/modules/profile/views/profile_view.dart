...
class ProfileView extends GetView<ProfileController> {
  ...
  // directcall() async {
  //   await FlutterPhoneDirectCaller.callNumber('9817189947');
  // }
  ...
  Widget build(BuildContext context) {
    ...
    final coverHeight = Get.height / 8;
    ...
    return Scaffold(
      ...
      body: GetBuilder<ProfileController>(
        builder: (controller) {
          ...
          var user = controller.userResponse!.users!;
          return Column(
            children: [
              Stack(
                            ...
                            children: [
                              IconButton(
                                icon: Icon(MdiIcons.accountEdit,
                                    size: 30,
                                    color:
                                        // const Color.fromARGB(255, 63, 112, 198),
                                        AppColors.buttonColor), // Edit icon
                                onPressed: () {
