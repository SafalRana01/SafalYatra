...
if (isset($_POST['code'], $_POST['otp'])) {
        ...
        $sqlSelect = "SELECT * FROM car_operators WHERE activation_code = '".$activation_code."'";
        ...
        if($result->num_rows > 0 ) {
            ...
            if ($rowOtp !== $otp){
                ...
                if (date('d-m-Y h:i:s') >= $timeUp){
                    ...
                    $sqlUpdate = "UPDATE car_operators SET otp = '', status ='active' WHERE  otp = '".$otp."' AND activation_code = '".$activation_code."'";
