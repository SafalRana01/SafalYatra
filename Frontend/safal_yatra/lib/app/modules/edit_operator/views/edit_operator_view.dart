...
class EditOperatorView extends GetView<EditOperatorController> {
  final Operators operator = Get.arguments;
  EditOperatorView({Key? key}) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: ConstrainedBox(
          ...
          child: GetBuilder<EditOperatorController>(
            builder: (controller) {
              return Form(
